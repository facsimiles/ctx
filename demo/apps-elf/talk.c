...
char *slide_intro0[]=
{
  ...
  "used","by:", "flow3r", "card10", "ctx terminal,","GEGL","&","(GIMP)\n",
...
char *slide_backends[]=
{
  ...
  "Use ctx_width(ctx) and ctx_height(ctx) and adapt the ui size to the provided viewport size\n",
  NULL
};
...
char *slide_mcu[]=
{
  ...
  "flow3r 240x240\n",
  "  lx7 240mhz","~400kb internal RAM + ","8mb PSRAM\n",
  "rp2040 various\n",
  "  ARM Cortex-M0","133mhz (OC 270mhz) ~512kb RAM\n",
