...
ctx: ctx.c vt/*.[ch] ctx.h  Makefile
	$(CC) ctx.c vt/*.c -o $@ -g -I. -Ifonts -Ivt `pkg-config sdl2 --cflags --libs` -lutil -Wall  -lz -lm -Wextra -Wno-implicit-fallthrough -Wno-unused-parameter -Wno-missing-field-initializers
